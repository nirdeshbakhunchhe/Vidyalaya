...
const CourseAssetsUploadModal = ({ course, onClose, onAssetsUploaded }) => {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 w-full max-w-lg max-h-[92vh] flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100 dark:border-slate-700 flex-shrink-0">
          <div className="min-w-0">
            <h3 className="text-lg font-bold text-slate-900 dark:text-white">Upload Course Assets</h3>
          ...
          <button
            ...
            className="w-8 h-8 rounded-xl flex items-center justify-center text-slate-400 hover:text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-800 transition-colors ml-4 flex-shrink-0 focus:outline-none focus:ring-2 focus:ring-slate-300"
          >
            <FaTimes />
          </button>
        </div>
