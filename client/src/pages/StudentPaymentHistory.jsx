...
const STATUS_META = {
  completed: {
    label: 'Completed',
    icon:  FaCheckCircle,
    pill:  'bg-green-100 dark:bg-green-900/30 text-green-700',
  },
  pending: {
    label: 'Pending',
    icon:  FaClock,
    pill:  'bg-amber-100 dark:bg-amber-900/30 text-amber-700',
  },
  failed: {
    label: 'Failed',
    icon:  FaTimesCircle,
    pill:  'bg-red-100 dark:bg-red-900/30 text-red-700',
  },
};
